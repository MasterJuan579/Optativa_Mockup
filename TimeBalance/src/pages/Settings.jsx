  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-400 mt-2">Personaliza tu experiencia en TimeBalance</p>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
        ...
        <div className="space-y-4">
          ...
          <button className="px-6 py-2 bg-indigo-600 dark:bg-indigo-500 text-white rounded-lg hover:bg-indigo-700 dark:hover:bg-indigo-600 transition-colors">
            Guardar Cambios
          </button>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
        <div className="flex items-center space-x-3 mb-6">
          ...
          <h2 className="text-xl font-bold text-gray-800 dark:text-white">Preferencias de Notificaciones</h2>
        </div>
        <div className="space-y-4">
          {[
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
        <div className="flex items-center space-x-3 mb-6">
          ...
          <h2 className="text-xl font-bold text-gray-800 dark:text-white">Horario de Trabajo/Clases</h2>
        </div>
        <div className="grid md:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Hora inicio trabajo</label>
            <input
              type="time"
              defaultValue="06:00"
              className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Hora fin trabajo</label>
            <input
              type="time"
              defaultValue="12:30"
              className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Hora inicio clases</label>
            <input
              type="time"
              defaultValue="13:00"
              className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Hora fin clases</label>
            <input
              type="time"
              defaultValue="17:00"
              className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
        <div className="flex items-center space-x-3 mb-6">
          ...
          <h2 className="text-xl font-bold text-gray-800 dark:text-white">Tema</h2>
        </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border-2 border-red-200 dark:border-red-800">
        <div className="flex items-center space-x-3 mb-6">
          ...
          <h2 className="text-xl font-bold text-gray-800 dark:text-white">Zona Peligrosa</h2>
        </div>
        <div className="space-y-3">
          <button className="w-full md:w-auto px-6 py-2 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors flex items-center justify-center space-x-2">
            <Download className="w-4 h-4" />
            <span>Exportar Datos</span>
          </button>
          <button className="w-full md:w-auto px-6 py-2 bg-red-600 dark:bg-red-500 text-white rounded-lg hover:bg-red-700 dark:hover:bg-red-600 transition-colors flex items-center justify-center space-x-2">
